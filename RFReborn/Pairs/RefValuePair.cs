namespace RFReborn.Pairs
{
    ...
    public readonly ref struct RefValuePair<T>
    {
        ...
        public static implicit operator RefValuePair<T>((T left, T right) args)
        {
            return new RefValuePair<T>(args.left, args.right);
        }
        ...
        public static implicit operator RefValuePair<T>(Pair<T> pair)
        {
            return new RefValuePair<T>(pair.Left, pair.Right);
        }
        ...
        /// </summary>
        /// <param name="pair"></param>
        public static implicit operator RefValuePair<T>(ValuePair<T> pair)
        {
            return new RefValuePair<T>(pair.Left, pair.Right);
        }
    }
